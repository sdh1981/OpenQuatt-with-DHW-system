...
// Generated by generate_hp_perf_map.py — run tools/generate_hp_perf_map.py to regenerate
// Model    : Quatt Duo single-HP unit
// Data ver : 1.1
// WARNING  : Tamb=+17, +20 rows are ESTIMATED (linear extrapolation).
//            Replace with real manufacturer data when available.
// NAN cells : operating points not published by the manufacturer (high compressor
//            level + high supply temperature). The compressor cannot sustain these
//            combinations reliably; interp_3d() propagates NAN so callers can
//            detect and reject the result rather than using extrapolated nonsense.
// Provides thermal power (W) and COP as function of (level, Tamb, Tsup).
#include <cmath>

namespace oq_perf {

static constexpr int N_AMB = 7;
static constexpr int N_SUP = 3;
static constexpr int N_LVL = 10; // levels 1..10

static constexpr float T_amb_bp[N_AMB] = {-15.00f, -7.00f, 2.00f, 7.00f, 12.00f, 17.00f, 20.00f};
...
static constexpr float P_th_W[N_AMB][N_SUP][N_LVL] = {
  ...
  // ESTIMATED — linear extrapolation from +7→+12 trend
  {
    {2984.23f, 3686.95f, 4480.96f, 4964.12f, 5452.26f, 5945.47f, 6360.28f, 6946.93f, NAN, NAN},
    {2625.33f, 3339.38f, 4146.03f, 4636.69f, 5132.43f, 5633.14f, 6054.30f, 6649.70f, NAN, NAN},
    {1842.90f, 2568.23f, 3387.47f, 3885.73f, 4388.97f, 4897.29f, 5324.68f, 5928.95f, NAN, NAN}
  },
  // ESTIMATED — linear extrapolation from +7→+12 trend
  {
    {3258.19f, 4002.25f, 4842.16f, 5352.89f, 5868.57f, 6389.35f, 6827.11f, 7445.92f, NAN, NAN},
    {2869.56f, 3624.95f, 4477.53f, 4995.73f, 5519.04f, 6047.29f, 6491.43f, 7118.96f, NAN, NAN},
    {2057.43f, 2824.07f, 3689.24f, 4215.07f, 4745.85f, 5281.74f, 5732.08f, 6368.51f, NAN, NAN}
  },
};
...
static constexpr float COP[N_AMB][N_SUP][N_LVL] = {
  ...
  // ESTIMATED — linear extrapolation from +7→+12 trend
  {
    {6.29f, 6.28f, 6.21f, 6.12f, 6.03f, 5.90f, 5.78f, 5.59f, NAN, NAN},
    {4.81f, 4.88f, 4.89f, 4.87f, 4.82f, 4.74f, 4.68f, 4.55f, NAN, NAN},
    {3.28f, 3.43f, 3.51f, 3.55f, 3.56f, 3.55f, 3.51f, 3.44f, NAN, NAN}
  },
  // ESTIMATED — linear extrapolation from +7→+12 trend
  {
    {6.76f, 6.74f, 6.65f, 6.54f, 6.44f, 6.29f, 6.16f, 5.95f, NAN, NAN},
    {5.22f, 5.27f, 5.26f, 5.22f, 5.16f, 5.06f, 4.99f, 4.84f, NAN, NAN},
    {3.62f, 3.75f, 3.80f, 3.83f, 3.83f, 3.81f, 3.75f, 3.66f, NAN, NAN}
  },
};
